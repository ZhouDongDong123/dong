	    ...
	    <!-- pageInfo.list -->
    		<c:forEach items="${pageInfo.list}" var="employee"> 	 
			        ...
			        <td class="center">${employee.email}</td>
			         <td class="center">
			            <span class="label-success label label-default">${employee.emptype}</span>
			        </td>
        ...
        <div class="row">
                ...
                <div class="col-md-6" style="margin-left: 70%;">
                    <nav aria-label="Page navigation">
                      ...
                      -->
                       <li>
                            <a href="${pageContext.request.contextPath}/showEmployeeByCondition.action?pn=1">首页</a>
                       </li>
                       <!-- 如果还有前页就访问当前页码-1的页面， -->
                       <c:if test="${pageInfo.hasPreviousPage}">
                         <li>
                          <a href="${pageContext.request.contextPath}/showEmployeeByCondition.action?pn=${pageInfo.pageNum-1}" aria-label="Previous">
                        ...
                        <!--遍历所有导航页码，如果遍历的页码页当前页码相等就高亮显示，如果相等就普通显示  -->
                          <c:forEach items="${pageInfo.navigatepageNums }" var="page_Nums">
                            ...
                            <c:if test="${page_Nums!=pageInfo.pageNum }">
                             <li ><a href="${pageContext.request.contextPath}/showEmployeeByCondition.action?pn=${page_Nums}">${page_Nums}</a></li>
                            </c:if>
                          </c:forEach>
                        </li>
                         <!-- 如果还有后页就访问当前页码+1的页面， -->
                        <c:if test="${pageInfo.hasNextPage}">
                            <li>
                              <a href="${pageContext.request.contextPath}/showEmployeeByCondition.action?pn=${pageInfo.pageNum+1}" aria-label="Next">
                                <span aria-hidden="true">&raquo;</span>
                              </a>
                            </li>
                        </c:if>
                         <li><a href="${pageContext.request.contextPath}/showEmployeeByCondition.action?pn=${pageInfo.pages}">末页</a></li>
                      </ul>
                    </nav>
                </div>
        </div>
